    ...
    <Joyride
      ...
      styles={{
        ...
        tooltip: {
          borderRadius: 10,
          padding: 16,
          // Cap the bubble so it can't push the footer off the viewport
...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    // `top` explicitly — both the + and ? buttons live in the bottom-right
    // corner. `auto` was mistakenly picking bottom/right on some viewports
    // and clipping the tooltip footer (Next/Back/Skip) off-screen.
    placement: 'top',
    title: 'Quick-create',
    content:
      'Tap this + button (or press C) to add a project, yarn, pattern, or tool fast.',
  },
  {
    ...
    content:
      'The ? button opens a step-by-step how-to for every tool on whatever page you are on.',
  },
  {
    target: 'body',
    placement: 'center',
