    ...
    <div className="space-y-4 md:space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
          Smart tools that do the knitting math for you — gauge checks, yarn substitution, sizing,
          and feasibility analysis. Every helper pulls from your stash and pattern library.
        </p>
      </div>
